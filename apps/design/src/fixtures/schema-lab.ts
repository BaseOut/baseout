...
const tables: SchemaTable[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'f-dl-stage', name: 'Stage', type: 'single_select', options: ['Lead', 'Qualified', 'Proposal', 'Negotiation', 'Closed Won', 'Closed Lost'], airtableDescription: 'Current pipeline stage.', airtableDraft: 'Current pipeline stage. Advances automatically as a deal moves between Kanban columns — do not edit by hand; use the board instead.', airtableExternallyChanged: true, description: 'The deal’s position in the sales pipeline, from first lead through to a closed (won or lost) outcome.', technicalDescription: 'Single-select enum with a fixed six-value option set: Lead → Qualified → Proposal → Negotiation → {Closed Won | Closed Lost}. The last two are terminal states (Closed Won / Closed Lost); the first four are open-pipeline. Drives the Kanban board grouping and forecast/weighted-value reporting, and is advanced by automation as cards move between columns — avoid editing the value directly. Changing the option set is a schema change and may orphan records on retired values.' },
...
const changelog: ChangelogEntry[] = [
  ...
  { id: 'cl-6', at: '2026-06-18T10:05:00', base: 'Marketing', table: 'Campaigns', type: 'view', summary: 'View “Active Campaigns” added to Campaigns', aiSummary: 'A new view changes how records are displayed, not the data itself. No records are affected.' },
