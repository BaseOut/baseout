// R2 key builder for managed-bucket backup output.
//
...
//
// orgSlug fills {user-root} for managed R2 (BYOS destinations replace this
// with their configured root in a later phase). `:` in the timestamp is
