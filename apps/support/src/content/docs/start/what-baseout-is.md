...
Which of the three a run takes depends on the Space's scope, and you choose between Schema Only and
Schema and Data. The two layers also run on separate cadences, because structure is small and cheap
to capture while records are neither. Monthly, weekly, daily and instant are all available. See
