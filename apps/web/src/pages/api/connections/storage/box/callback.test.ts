/**
 * Pins the post-OAuth redirect origin for the Box callback (parity with
...
const WRONG_HOST_CALLBACK =
  'https://baseout-dev.openside.workers.dev/api/connections/storage/box/callback?error=access_denied'

describe('Box callback — post-OAuth redirect origin', () => {
  beforeEach(() => {
