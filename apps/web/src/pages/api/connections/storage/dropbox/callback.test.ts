/**
 * Pins the post-OAuth redirect origin for the Dropbox callback (parity with
...
const WRONG_HOST_CALLBACK =
  'https://baseout-dev.openside.workers.dev/api/connections/storage/dropbox/callback?error=access_denied'

describe('Dropbox callback — post-OAuth redirect origin', () => {
  beforeEach(() => {
