/**
 * Pins the post-OAuth redirect origin for the Google Drive callback (parity with
...
const WRONG_HOST_CALLBACK =
  'https://baseout-dev.openside.workers.dev/api/connections/storage/google-drive/callback?error=access_denied'

describe('Google Drive callback — post-OAuth redirect origin', () => {
  beforeEach(() => {
