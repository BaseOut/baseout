          ...
          rows: [
            {
              ...
              control: 'link',
              cta: 'Change plan',
              note: 'Plan changes are handled in the billing portal — see Payment below.',
            },
            {
              id: 'billing-usage',
        ...
        },
        {
          ...
          rows: [
            ...
            },
            {
              id: 'billing-email',
              label: 'Billing email',
              desc: 'Where invoices and receipts are sent. Managed in the Stripe portal.',
              control: 'text',
              value: user.email,
              gated: true,
            },
            {
              ...
              control: 'link',
              cta: 'View invoices',
              note: 'Invoices live in the billing portal — open it from Payment method above.',
            },
          ],
        },
        {
          ...
          rows: [
            {
              id: 'billing-overage',
              label: 'Allow overage',
              desc: 'Keep backing up past your allowance and bill the difference, instead of stopping.',
              control: 'toggle',
              on: false,
              gated: true,
            },
