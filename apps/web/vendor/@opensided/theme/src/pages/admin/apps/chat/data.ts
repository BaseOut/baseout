...
export const chatsData: IChatItem[] = [
    {
        ...
        messages: [
            ...
            { message: "Just finished a great book. Have any recommendations?", sendAt: "04:34 PM", sender: "other" },
            { message: "That's awesome! I'd recommend 'The Silent Observer.'", sendAt: "04:36 PM", sender: "me" },
            { message: "Thanks! I'll check it out.", sendAt: "04:37 PM", sender: "other" },
            { message: "Did you catch the latest movie? It's fantastic!", sendAt: "04:38 PM", sender: "me" },
            ...
            { message: "Sounds intriguing. I'll add it to my watchlist.", sendAt: "04:44 PM", sender: "other" },
            { message: "Great! Let me know what you think after watching.", sendAt: "04:46 PM", sender: "me" },
        ],
    },
    {
        id: 2,
        ...
        messages: [
            ...
            { message: "Just got a new book. Excited to start reading.", sendAt: "02:25 PM", sender: "other" },
    ...
    },
    {
        ...
        messages: [
            ...
            { message: "I'm planning a weekend getaway. Any suggestions?", sendAt: "03:10 PM", sender: "me" },
            { message: "Just tried a new recipe. Turned out delicious!", sendAt: "03:15 PM", sender: "other" },
            { message: "Looking forward to the weekend. Any exciting plans?", sendAt: "03:20 PM", sender: "me" },
            { message: "Have you seen the new movie everyone is talking about?", sendAt: "03:30 PM", sender: "other" },
        ],
    },
    {
        id: 4,
        ...
        messages: [
            ...
            { message: "Thinking of trying a new recipe for dinner.", sendAt: "05:05 PM", sender: "other" },
            { message: "Just finished a great workout at the gym.", sendAt: "05:10 PM", sender: "me" },
            { message: "Planning a weekend getaway. Any suggestions?", sendAt: "05:15 PM", sender: "other" },
            { message: "Excited about the upcoming project at work.", sendAt: "05:20 PM", sender: "me" },
            { message: "Looking forward to the weekend. Any fun plans?", sendAt: "05:25 PM", sender: "other" },
        ],
    },
    {
        id: 5,
        ...
        messages: [
            ...
            { message: "Thinking of starting a new hobby. Any suggestions?", sendAt: "01:15 PM", sender: "other" },
    ...
    },
    {
        ...
        messages: [
            ...
            { message: "Did you watch the latest episode of that show?", sendAt: "06:05 PM", sender: "other" },
            ...
            { message: "Just tried a new recipe. It turned out amazing!", sendAt: "06:25 PM", sender: "other" },
        ],
    },
];
