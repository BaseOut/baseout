...
// node:fs available. CSVs land under apps/workflows/.backups/ at the
// relative path produced by buildR2Key (kept named "R2 key" for historical
// reasons — the string is now just a backup-tree-relative path).
//
// BACKUP_ROOT is anchored to this file's location so the destination is
// stable regardless of the Trigger.dev runner's cwd:
//   <this file>/../../../.backups → apps/workflows/.backups
//
