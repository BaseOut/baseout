...
| **4** | Remaining tabs (Visualize/Relationships/Health/Changelog/Docs/Chat) one-by-one | **IN PROGRESS** — Visualize ws-grouping + Relationships tip UI DONE; Health→Chat still live `*Tab` |
