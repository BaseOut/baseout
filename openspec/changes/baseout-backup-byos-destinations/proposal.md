...
- Update [openspec/changes/baseout-backup/specs/storage-destinations/spec.md](../baseout-backup/specs/storage-destinations/spec.md) — link this change as the implementation.
