...
[openspec/changes/baseout-backup/specs/airtable-webhook-coalescing/spec.md](../baseout-backup/specs/airtable-webhook-coalescing/spec.md) already specs the coalescing contract. This change is its implementation.
...
- **New Trigger.dev task** `apps/server/trigger/tasks/incremental-backup.task.ts`:
...
- Update [openspec/changes/baseout-backup/specs/airtable-webhook-coalescing/spec.md](../baseout-backup/specs/airtable-webhook-coalescing/spec.md) — link as implementation.
- Update [openspec/changes/baseout-backup-schedule-and-cancel/proposal.md](../baseout-backup-schedule-and-cancel/proposal.md) Out-of-Scope — link as resolved.
