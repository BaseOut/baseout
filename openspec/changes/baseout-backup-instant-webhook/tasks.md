...
- [ ] D.1 New task `apps/server/trigger/tasks/incremental-backup.task.ts` per design.md §Phase D.
...
- [ ] G.1 Update [openspec/changes/baseout-backup/specs/airtable-webhook-coalescing/spec.md](../baseout-backup/specs/airtable-webhook-coalescing/spec.md) — link this change.
- [ ] G.2 Update [openspec/changes/baseout-backup-schedule-and-cancel/proposal.md](../baseout-backup-schedule-and-cancel/proposal.md) Out-of-Scope.
