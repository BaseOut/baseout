...
- Update [openspec/changes/baseout-backup-schedule-and-cancel/proposal.md](../baseout-backup-schedule-and-cancel/proposal.md) and [openspec/changes/baseout-backup-retention-and-cleanup/proposal.md](../baseout-backup-retention-and-cleanup/proposal.md) to link this change as the resolved credit-charge surface.
