...
The engine has the building blocks today (per [openspec/changes/baseout-backup/specs/backup-engine/spec.md](../baseout-backup/specs/backup-engine/spec.md) Requirement "Trial cap enforcement"): it caps records + tables + attachments mid-run and sets `status='trial_complete'`. What's missing:
...
- Update [openspec/changes/baseout-backup/specs/backup-engine/spec.md](../baseout-backup/specs/backup-engine/spec.md) trial-cap requirement — point to this change as the implementation of the pre-flight gate.
