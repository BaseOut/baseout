...
- Update [openspec/changes/baseout-server/proposal.md](../baseout-server/proposal.md) Out-of-Scope section if it still references attachments as a placeholder.
