# baseout-backup-instant-webhook
...
Depends on `baseout-backup-dynamic-mode` shipping — Instant backups write incremental record changes to the dynamic DB, not to a CSV snapshot.
