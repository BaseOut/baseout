...
- [ ] D.1.2 Workflows-side attachment-byte tracking + emission lives in [`baseout-workflows-manual-quota-and-credits`](../baseout-workflows-manual-quota-and-credits/tasks.md).
...
- [ ] H.1 Update [openspec/changes/baseout-server-schedule-and-cancel/proposal.md](../baseout-server-schedule-and-cancel/proposal.md) — link this change as the resolved credit-charge surface.
- [ ] H.2 Update [openspec/changes/baseout-server-retention-and-cleanup/proposal.md](../baseout-server-retention-and-cleanup/proposal.md) — link this change as resolving the Phase D credit-charge interlock.
