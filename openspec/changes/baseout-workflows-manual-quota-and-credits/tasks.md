...
- [ ] 1.1 Update `apps/workflows/trigger/tasks/backup-base.ts` — `BackupBaseResult` interface adds `attachmentBytesByBase` (already-empty in the trivial case; populated when `baseout-workflows-attachments` ships).
