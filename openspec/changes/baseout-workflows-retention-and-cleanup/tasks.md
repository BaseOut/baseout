...
- [ ] 4.2 Cross-check that the server-side `baseout-server-retention-and-cleanup` Phase C tasks no longer carry the duplicated `C.3.1`/`C.3.2`/`C.3.3` bullets (those moved here).
