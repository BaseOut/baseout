...
7. Update `web` specs (design.md, tasks.md) to reflect the new routing
8. Update `server` design.md to reflect HMAC enforcement and removal of direct browser contract
