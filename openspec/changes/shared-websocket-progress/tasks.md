...
- [ ] 5.4 Update `openspec/changes/shared-client-isolation/tasks.md` task 2.x to mark these as the implementing change; on archive of this change, the `web-live-progress` capability merges into `openspec/specs/`.
