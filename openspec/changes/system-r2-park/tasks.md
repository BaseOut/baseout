...
- [ ] 4.1 Edit [shared/Baseout_PRD.md](../../../shared/Baseout_PRD.md) §7.2 destinations table — change the R2 row from `Cloudflare R2 (Baseout-managed) — ✓ (default)` to `Cloudflare R2 (Baseout-managed) — V2 (paused per system-r2-park)`.
- [ ] 4.2 Edit [shared/Baseout_PRD.md](../../../shared/Baseout_PRD.md) §20.2 — update the encryption claim from "managed-R2 server-side encryption + …" to "BYOS-provider TLS + encryption-at-rest; managed-R2 path paused."
- [ ] 4.3 Edit [shared/Baseout_Features.md](../../../shared/Baseout_Features.md) §6.6 — same row update as 4.1.
- [ ] 4.4 Edit [shared/Baseout_Backlog_MVP.md](../../../shared/Baseout_Backlog_MVP.md) — mark R2-keyed items deferred (grep `r2` in the file).
- [ ] 4.5 Edit [shared/Baseout_Implementation_Plan.md](../../../shared/Baseout_Implementation_Plan.md) — add a one-line note where R2 is referenced as a build step: the R2 step is paused; BYOS-first replaces it.

## Phase 5 — Memory hygiene

- [ ] 5.1 Update [`project_r2_informal_veto.md`](file:///Users/autumnshakespeare/.claude/projects/-Users-autumnshakespeare-baseout/memory/project_r2_informal_veto.md) — change the title and body from "informal veto" to "documented pause via system-r2-park." Reference this change's archive path once it lands.
- [ ] 5.2 Update the matching one-line entry in [`MEMORY.md`](file:///Users/autumnshakespeare/.claude/projects/-Users-autumnshakespeare-baseout/memory/MEMORY.md) to match the new title.
