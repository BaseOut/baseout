# web-workspace-rediscovery

The frontend half of workspace-base rediscovery. Pairs with [`server-workspace-rediscovery`](../server-workspace-rediscovery/proposal.md) (the engine writes; this side reads + dispatches).
