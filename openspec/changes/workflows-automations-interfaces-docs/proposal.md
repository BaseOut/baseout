...
- POST the gathered blob to a new engine internal endpoint owned by the server-side sibling (TBD route — see `server-automations-interfaces-docs`). Engine persists the blob to the appropriate DB columns.
