 ...
 *
 * The `baseout` pgSchema instance declared here is also imported by sibling
 * schema files (e.g. apps/web/src/db/schema/core.ts) so every table lives in
 * the same Postgres schema namespace.
 */
