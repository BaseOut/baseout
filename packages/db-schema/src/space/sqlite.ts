 ...
 * column types differ. Keep the two in lockstep; tests/space-schema-parity.test.ts
 * asserts that table names and column names match across pg.ts and sqlite.ts.
 *
