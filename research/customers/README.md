...
| `airtable-devops-term.md` | Usage guide for the category term **"Airtable DevOps"** — why it won, where it's used (and never used), the standing gloss, approved definitions/pillars/maturity vocabulary, rejected alternatives, claim hygiene. |
